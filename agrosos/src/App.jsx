        ...
        <tbody>
          {data.plots.map(plot => (
            <tr key={plot.id}>
              ...
              <td>
                {editingPlot === plot.id ? (
                  <button onClick={() => handleUpdatePlot(plot.id)}>Actualizar</button>
                ) : (
                  <>
                    <button onClick={() => handleEditClick(plot)}>Editar</button>
                    <button onClick={() => handleDeletePlot(plot.id)}>Eliminar</button>
                  </>
                )}
              </td>
            </tr>
